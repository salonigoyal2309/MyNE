<?php
	...
	$tbi=0;
	$selectqry = "SELECT o.orderid, o.userid, o.receipt, o.tt_complete, o.order_time, o.price, u.username from orders o INNER JOIN user_account u on o.userid = u.email and u.email='".$_GET['email']."'";
