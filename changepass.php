<?php
	...
	if(isset($_POST['change'])){
		...
		if(!$error){
			$search_qry="SELECT * FROM user_account WHERE email='".$_SESSION['email']."' and password='".$oldpass."'";
		...
		//Search completed
				...
				$upd_qry="UPDATE user_account set password='".$newpass."' where email='".$_SESSION['email']."';";
